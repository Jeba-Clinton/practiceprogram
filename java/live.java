...
public class gamer extends Frame { // Class names should start with uppercase letters and follow CamelCase convention
   // Label l1, l2; // It's good practice to use private access modifiers for encapsulation
    Checkbox c1, c2;
...
class live{
    public static void main(String[] args) {
        gamer fr=new gamer(); // No need to assign to a variable if it's not going to be used
    }
}
